...
/**
 * 4. Podcast 列表渲染 - 最終整合多語系修正版
 * 解決播放器反白、內容遮擋與背景質感問題，並修復多語系陣列死鎖
 */
function renderPodcastList() {
    ...
    // 💡 核心修復：在 map 中加入 index 變數，精準依集數讀取對應的中英文標題字串
    const listHtml = config.podcastList.map((item, index) => `
        <div class="podcast-item">
            ...
            <div style="flex: 1; overflow: hidden;">
                <!-- 💡 核心修復：改用 item.title[index] 讀取特定集數的多語系標題 -->
                <h4 style="color: #68BFFF; font-size: 16px; margin-bottom: 8px; text-align: left;">${item.title[index]}</h4>
